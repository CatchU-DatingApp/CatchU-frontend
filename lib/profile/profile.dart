...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadUserProfile() async {
    ...
    try {
      ...
      if (user != null) {
        final uid = user.uid;
        final response = await http.get(Uri.parse('http://172.20.10.3:8080/users/$uid'));
    ...
    if (pickedFile != null && user != null) {
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse('http://172.20.10.3:8080/users/${user.uid}/photos'),
              ...
              onTap: () async {
                ...
                try {
                  ...
                  final deleteResponse = await http.post(
                    Uri.parse('http://172.20.10.3:8080/users/${user.uid}/photos/delete'),
                    headers: {'Content-Type': 'application/json'},
                    body: jsonEncode({'photoUrl': photoUrl}),
                  );
  ...
  Future<void> _updateUserProfile(Map<String, dynamic> data) async {
    ...
    if (user != null) {
      final uid = user.uid;
      final url = Uri.parse('http://172.20.10.3:8080/users/update-fields/$uid');
